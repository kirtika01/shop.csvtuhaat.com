																	...
																	<li>
																		<div class="quantity_input" style="border-radius: 65px;">
																			<form action="#">
																				...
																				<input style="background-color: transparent;" class="input_number" type="number" min="1" id="qty<?=$i?>" value="<?= $row->cart_qty?>">
...
<script>
	...
	//	alert("hii");
        $.ajax({
            type: "POST",
            url: "Base/remove_cart_item", // Update the URL to the correct controller method
            data: {
                cart_id: cartId
            },
            success: function(response) {
