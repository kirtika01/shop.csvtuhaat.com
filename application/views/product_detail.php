							...
							<div class="container">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div class="shop_details_content">
										...
										<ul class="btns_group_1 ul_li mb_30 clearfix" style="padding: 5%;display: <?= $add ?>;" id="add" >
											<li>
												<div class="quantity_input">
													<form action="#">
														<span class="input_number_decrement">–</span>
														<input class="input_number" type="text" value="1" id="qty111">
														<span class="input_number_increment">+</span>
													</form>
												</div>
											</li>
											<li>
												<a class="custom_btn bg_black text-uppercase" href="#!" onclick="add(<?= $product->id ?>)"><i class="fal fa-shopping-bag mr-2"></i> Add To Cart</a>
											</li>
										</ul>
										<ul class="btns_group_1 ul_li mb_30 clearfix" style="padding: 5%;display: <?= $goto ?>;" id="goto-cart">
											
											<li>
												<a class="custom_btn bg_black text-uppercase" href="<?= base_url() ?>cart" ><i class="fal fa-shopping-bag mr-2"></i> Go To Cart</a>
											</li>
										</ul>
