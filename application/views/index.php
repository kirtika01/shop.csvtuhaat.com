				...
				<div class="container maxw_1460">
					...
					<!-- write -->
						<div class="col-lg-7 banner-section">
							...
							<?php
							$banners=$this->db->select('banner_image')->from('banner_tbl')->get()->result();
							// print_r($banners);
							?>
							
								<!-- <div class="item clearfix">
									<div class="slider_image order-last" data-animation="fadeInUp" data-delay=".2s">
										<img style="width:100%;" src="<?= base_url() ?>admin/assets/uploads/<?= $banner->banner_image ?>" alt="image_not_found" width="100%">
									</div>
								</div> -->
							<!-- </div>
						...
						<?php foreach ($banners as $banner): ?>
								<div class="item clearfix" data-bg-color="#ffc156">
									<div class="slider_image order-last" data-animation="fadeInUp" data-delay=".2s">
										<img src="<?= base_url() ?>admin/assets/uploads/<?= $banner->banner_image ?>" alt="image_not_found" width="100%">
									</div>
						 ...
						 ?>
							...
							<div class="sm_offer_item offer_fullimage text-white mb_30">
								...
								<div class="item_content">
									...
									<a class="text_btn" href="<?= base_url()?>category_products/<?= $value->id ?>">
										<span>Order Now</span>
							...
							<div class="supermarket_sidebar_tab mb_30">
								...
								<ul class="ul_li_block nav" role="tablist">
									<?php 
										...
										?>
										<li><a class="active" href="<?= base_url()?>category_products/<?=$row->id?>"><?= $row->category_name ?></a></li>
									<?php } } ?>
										...
										<li>
											<div class="supermarket_product_item">
												...
												<div class="item_content">
													...
													?>
													<div id="add<?= $i ?>" style="display: <?= $add ?>;">
													...
													<div id="goto-cart<?= $i ?>" style="display: <?= $goto  ?>;">
		...
		<?php }} ?>
			...
			================================================== -->
			<section class="advertisement_section sec_ptb_50 pb-0 clearfix" hidden="">
				<div class="container maxw_1460">
			...
			================================================== -->
			<section class="bestseller_section sec_ptb_50 pb-0 clearfix" hidden="">
				<div class="container maxw_1460">
			...
			<!-- advertisement_section - start
			================================================== -->
			<section class="advertisement_section sec_ptb_50 clearfix" hidden="">
				<div class="container maxw_1460">
					<div class="row justify-content-center">
						<div class="col-lg-4">
							<div class="sm_offer_item offer_fullimage text-white">
