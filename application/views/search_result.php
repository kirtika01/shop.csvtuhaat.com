    ...
    <div class="container maxw_1460">
        ...
        <div class="col-lg-3">
							<div class="supermarket_advertisement_3 delivery dhide pb-20">
								<img src="//localhost/shop.csvtuforte.com/assets/images/shop/delivery.png" alt="image_not_found">
								<!-- <img src="//localhost/shop.csvtuforte.com/assets/images/offer/supermarket/img_05.jpg" alt="image_not_found"> -->
							...
							<div class="supermarket_sidebar_tab mb_30">
								...
								<ul class="ul_li_block nav" role="tablist">
																			<li><a class="active" href="//localhost/shop.csvtuforte.com/category_products/1">Herbal and Forest Products</a></li>
																			<li><a class="active" href="//localhost/shop.csvtuforte.com/category_products/2">CG Cuisine's</a></li>
																			<li><a class="active" href="//localhost/shop.csvtuforte.com/category_products/3">Organic Fertilizer &amp;Pesticides</a></li>
																			<li><a class="active" href="//localhost/shop.csvtuforte.com/category_products/4">Art &amp; Craft of CG</a></li>
																			<li><a class="active" href="//localhost/shop.csvtuforte.com/category_products/5">Other Rural Enterprises</a></li>
                    ...
                    <div id="tab1" class="tab-pane active">
                        ...
                        <ul class="supermarket_product_columns has_4columns ul_li clearfix">
                            ...
                            <?php if (empty($results)): ?>
                                <p>No results found for '<?php echo $this->input->get('search'); ?>'</p>
                            <?php else: ?>
