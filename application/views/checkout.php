							        ...
							        <div style="display:flex;margin-top:-12px;">
	                       	  		...
	                       	  		<div class="row" id="location" style="display:;">
									          ...
									          <input
										        ...
										        maxlength="10"
										        required
										        onkeyup="get_userdetails(this.value)"
									          />
									        </label>
									         <label class="d-block mb-4">
...
/*get_userdetails*/
function get_userdetails(mobile) 
{
	// alert(mobile);
	$.ajax({
            type: "POST",
            url: "<?= base_url() ?>Base/get_userdetails", // Update the URL to the correct controller method
            data: {
                mobile: mobile
            },
            dataType : "json",
            success: function(response) {
               ...
               $('textarea#fulladdress').val(response.address);
